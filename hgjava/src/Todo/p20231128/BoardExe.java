...
public class BoardExe {
	...
	static {
		boards = new Board[100]; // 실행블럭 안에 만듦
	}
	...
	public static boolean addBoard(Board board) { // Board board로 매개변수지정
	...
	public static Board getBoard(int boardNo) { // Board.java에서 만들어준 변수이름이랑 상관없음
		for (int i = 0; i < boards.length; i++) {
