...
public class CafeApp {
	public static void main(String[] args, String pName, String dName) {
		...
		while (run) {
			...
			case 1: // 1.주문하기(등록)
				...
				System.out.println("포장유무를 선택해주세요(필수. 1:매장 2:포장)>>");
			...
			case 4: // 4.주문수정
				...
				if (modi == 1) {
					System.out.println("수정할 메뉴를 입력해주세요"); // 1선택
				} else {
					if (dao.modifyOrder(pName, dName, take, cuser)) {
						System.out.println("수정이 완료되었습니다");
					} else {
						System.out.println("수정이 취소되었습니다"); // 2선택
					}
				}
				break;
